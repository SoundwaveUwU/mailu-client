...
class UserCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['raw_password'] === null) {
            $invalidProperties[] = "'raw_password' can't be null";
        }
     ...
     * Sets raw_password
     *
     * @param string $raw_password The raw (plain text) password of the user. Mailu will hash the password using BCRYPT-SHA256
     *
     * @return self
     */
