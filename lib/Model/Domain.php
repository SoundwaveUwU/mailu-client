...
class Domain implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setMaxUsers($max_users)
    {
        ...
        if (($max_users < -1)) {
            throw new \InvalidArgumentException('invalid value for $max_users when calling Domain., must be bigger than or equal to -1.');
        }
    ...
    public function setMaxAliases($max_aliases)
    {
        ...
        if (($max_aliases < -1)) {
            throw new \InvalidArgumentException('invalid value for $max_aliases when calling Domain., must be bigger than or equal to -1.');
        }
    ...
    public function setMaxQuotaBytes($max_quota_bytes)
    {
        ...
        if (($max_quota_bytes < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_quota_bytes when calling Domain., must be bigger than or equal to 0.');
        }
